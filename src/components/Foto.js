...
class FotoAtualizacoes extends Component {
    constructor(props){
      super(props);
      this.state = {likeada: this.props.foto.likeada, comentarios: this.props.foto.comentarios}
    }
    ...
    like(event){
      ...
      .then(response =>{
        if(response.ok){
          ...
          throw new Error("Não foi possivel realizar o like na foto"); 
        }
      })
      .then(liker =>{
    ...
    render(){
        return (
            <section className="fotoAtualizacoes">
              ...
              <form onSubmit={this.comenta.bind(this)} className="fotoAtualizacoes-form">
        ...
        return (
            <div className="foto-in fo">
              <div className="foto-info-likes">
                {
                  this.state.likers.map( liker => <Link key={liker.login} to={`/timeline/${liker.login}`}>{liker.login}, </Link> )
                }
              ...
              <p className="foto-info-legenda">
                ...
                <br />
                <a>{this.props.foto.comentario}</a>
              </p>
